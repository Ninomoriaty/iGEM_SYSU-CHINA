...
/*! Implement left and right button in index*/
...
$(function(){
  $(document).on( 'scroll', function(){
    var lt1 = getOffset( document.getElementById('im1') ).top;
    var lt2 = getOffset( document.getElementById('im2') ).top;
    if ($(window).scrollTop() > (lt1-150)  &&  $(window).scrollTop() < (lt2-150)) {
      $('.hua1').collapse('show');
      $('.hua0').collapse('hide');
      $('.hua2').collapse('hide');
    };
...
$(function(){
  $(document).on( 'scroll', function(){
    ...
    if ($(window).scrollTop() > 500 &&  $(window).scrollTop() < (lt1-150)) {
      $('.hua0').collapse('show');
      $('.hua1').collapse('hide');
      $('.hua2').collapse('hide');
    } else if ($(window).scrollTop() > 500 &&  $(window).scrollTop() >= (lt1-150)) {
      $('.hua0').collapse('hide');
    }
